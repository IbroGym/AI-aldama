-- One-time setup: Supabase Dashboard -> SQL Editor -> paste all -> Run
-- https://supabase.com/dashboard/project/efgilabvyfpvdflksqqk/sql/new

-- Policies on alerts table
...
-- RPC (same as supabase/migrations/20260519140000_alerts_admin_rpc.sql)
